                ...
                ? [
                    {
                        files: [
                            {
                                file: geometryFile.name, // Replace with actual file content if needed
                            },
                        ],
                    ...
                    >
                        <form onSubmit={handleSubmit(onSubmit)}>
                            <div className="flex align-items-center justify-content-between align-items-center mb-2">
                                <label
                                    className={`font-semibold ${useCustomAlloy && "text-black-alpha-40"
                                        }`}
                                >
                            ...
                            <div className="flex flex-col mb-4">
                                <label className="font-semibold mb-2">Upload Geometry File</label>
                                <input
                                    type="file"
                                    accept=".txt,.json,.csv,.xml"
                                    onChange={(e) => setGeometryFile(e.target.files[0])}
                                    className="w-full"
                                />
                            </div>
                            ...
                            <div className="flex flex-col mb-4">
                                <label className="font-semibold mb-2">Geometry Description</label>
                                <textarea
                                    value={geometryDescription}
                                    onChange={(e) => setGeometryDescription(e.target.value)}
                                    className="w-full p-2"
                                    placeholder="Enter description for the geometry file"
                                />
                            </div>
